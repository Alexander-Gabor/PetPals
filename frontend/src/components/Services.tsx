      ...
      <div className="my-20">
        ...
        {SERVICES_CONTENT.map((service, index) => (
          <div key={index} className="mb-12 mx-4 flex flex-col lg:flex-row">
            ...
            <div
              className={`lg:w-1/2 flex justify-center flex-col ${index % 2 === 0 ? "lg:pl-12" : "lg:pr-12"}`}
            >
              ...
              {service.title === "Dog Adoption" && (
                <Link to="/dog-adoption" className="text-blue-500 underline">
                  Learn more
                </Link>
              )}
            </div>
